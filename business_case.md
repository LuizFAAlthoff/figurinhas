# Business Case: Projeto Figurinhas

## 1. Visão Geral
Uma rede social gamificada baseada no colecionismo de figurinhas digitais. O projeto será lançado como um MVP Web com foco em transição para App Mobile Nativo. Usuários transformam mídias em stickers, completam álbuns, trocam itens e interagem em um feed social através de coleções oficiais e independentes.
